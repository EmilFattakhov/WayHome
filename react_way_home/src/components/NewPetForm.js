    ...
    <>
     ...
     <div className='petform-container'>
       ...
       <form className='petform-form-container' onSubmit={(event) => { 
         ...
         <div className='petform-form'>
            <input type='text' name='location_lost' id='location_lost' value={location_lost} onInput={handleUpdate} autoComplete='off'></input>
         ...
         <div className='petform-form'>
            <input type='text' name='image2' id='image2' value={image2} onInput={handleUpdate} autoComplete='off'></input>
