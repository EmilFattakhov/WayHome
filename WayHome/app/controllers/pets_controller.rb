class PetsController < ApplicationController
    ...
    private
    def pet_params
        params.require(:pet).permit(:name, :description, :animal, :age, :sex, :breed, :colour, :location_lost, :distinctive_features, :flag, :time_lost, :image1, :image2, :image3, :locations)
    end
